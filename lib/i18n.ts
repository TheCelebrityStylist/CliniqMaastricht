...
export const ui = {
  ...
  en: {
    ...
    home: { eyebrow: 'Platielstraat 9A', hero: 'CLINIQ Maastricht', intro: 'Nightlife, events and workshops on Platielstraat.', proof: ['Platielstraat 9A', 'Club', 'Workshops', 'Events'], whyEyebrow: 'Photos', whyTitle: 'Photos', whyText: '', plan: 'Contact us', eventsTitle: 'This week at CLINIQ', eventsText: 'Thursday, Friday and Saturday at CLINIQ are built around music, drinks and a full dance floor. Check the agenda for the next nights.', noEventsTitle: 'New events soon.', noEventsText: '', albumsTitle: 'Photos from recent nights', albumsText: 'Browse the atmosphere from club nights, drinks and events at CLINIQ.', readyTitle: 'CLINIQ Maastricht', readyText: 'Platielstraat 9A. In the centre of Maastricht.' },
