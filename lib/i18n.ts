...
export const ui = {
  nl: {
    ...
    footer: { headline: 'CLINIQ Maastricht', text: 'De plek waar Maastricht samenkomt.', intro: 'De plek waar Maastricht samenkomt.', navigation: 'Navigatie', groups: 'Voor groepen', bachelor: 'Vrijgezellenfeest', corporate: 'Bedrijfsfeest', venue: 'Feestzaal Maastricht', route: 'Route & contact', lockers: 'Lockers' },
  ...
  en: {
    ...
    footer: { headline: 'CLINIQ Maastricht', text: 'Where Maastricht comes together.', intro: 'Where Maastricht comes together.', navigation: 'Navigation', groups: 'For groups', bachelor: 'Bachelor / bachelorette', corporate: 'Company event', venue: 'Venue hire Maastricht', route: 'Directions & contact', lockers: 'Lockers' },
