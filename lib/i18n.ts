...
export const ui = {
  nl: {
    ...
    home: { eyebrow: 'Platielstraat 9A', hero: 'CLINIQ Maastricht', intro: 'Club, cocktails en events aan de Platielstraat.', proof: ['Platielstraat 9A', 'Club', 'Cocktails', 'Events'], whyEyebrow: 'Foto’s', whyTitle: 'Foto’s', whyText: '', plan: 'Neem contact op', eventsTitle: 'Deze week bij CLINIQ', eventsText: 'Donderdag, vrijdag en zaterdag draait het bij CLINIQ om muziek, cocktails en een volle dansvloer. Check de agenda voor de eerstvolgende avonden.', noEventsTitle: 'Nieuwe events volgen.', noEventsText: '', albumsTitle: 'Sfeer van de afgelopen avonden', albumsText: 'Een selectie uit recente clubnachten, borrels en events.', readyTitle: 'CLINIQ Maastricht', readyText: 'Platielstraat 9A. Midden in Maastricht.' },
  ...
  en: {
    ...
    home: { eyebrow: 'Platielstraat 9A', hero: 'CLINIQ Maastricht', intro: 'Club, cocktails and events on Platielstraat.', proof: ['Platielstraat 9A', 'Club', 'Cocktails', 'Events'], whyEyebrow: 'Photos', whyTitle: 'Photos', whyText: '', plan: 'Contact us', eventsTitle: 'This week at CLINIQ', eventsText: 'Thursday, Friday and Saturday at CLINIQ are built around music, cocktails and a full dance floor. Check the agenda for the next nights.', noEventsTitle: 'New events soon.', noEventsText: '', albumsTitle: 'Recent nights', albumsText: 'A selection from recent club nights, drinks and events.', readyTitle: 'CLINIQ Maastricht', readyText: 'Platielstraat 9A. In the centre of Maastricht.' },
