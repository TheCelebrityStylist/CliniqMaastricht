...
export const pageMeta = {
  ...
  nightlife: {
    nl: { title: 'Uitgaan Maastricht | Club Cliniq — Do, Vr & Za open', description: 'Cliniq Maastricht is hét adres voor een avondje stappen. Donderdag 18+, vrijdag en zaterdag 21+, open vanaf 22:00 aan de Platielstraat 9A.' },
    en: { title: 'Nightlife Maastricht | Club Cliniq — Open Thu, Fri & Sat', description: "Cliniq is Maastricht's go-to club. Thursday (18+), Friday and Saturday (21+) from 22:00 on Platielstraat 9A." },
  },
  workshop: {
    nl: { title: 'Cocktail Workshop Maastricht | Cliniq — Vrijgezellenfeest & Bedrijfsuitje', description: 'Cocktail workshop in Maastricht bij Cliniq. Groepen van 15+, €15 per cocktail. Ideaal voor vrijgezellenfeesten en bedrijfsuitjes. Boek via WhatsApp.' },
  ...
  eventSpace: {
    nl: { title: 'Ruimte Huren Maastricht | Feestzaal Cliniq — Tot 400 personen', description: 'Feestlocatie huren in Maastricht? Cliniq biedt exclusieve zaalverhuur tot 400 personen voor privéfeesten, bedrijfsevents en vrijgezellenavonden.' },
    en: { title: 'Hire Venue Maastricht | Event Space Cliniq — Up to 400 guests', description: 'Hire a venue in Maastricht at Cliniq. Exclusive event space for up to 400 guests. Private parties, corporate events and hen nights.' },
  },
  contact: {
    nl: { title: 'Contact | CLINIQ Maastricht — Platielstraat 9A', description: 'Neem contact op met Cliniq Maastricht. Platielstraat 9A, 6211 GV. Open do, vr en za. Vragen over lockers, dresscode of ruimte huren?' },
    en: { title: 'Contact | CLINIQ Maastricht — Platielstraat 9A', description: 'Get in touch with Cliniq Maastricht. Platielstraat 9A, 6211 GV. Open Thu, Fri and Sat.' },
  },
  jobs: {
