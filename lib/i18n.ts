...
export const ui = {
  nl: {
    ...
    home: { eyebrow: 'Club · Cocktails · Events', hero: 'CLINIQ Maastricht', intro: 'Club. Cocktails. Events.', proof: ['Platielstraat 9A', 'Club', 'Cocktails', 'Events'], whyEyebrow: 'Foto’s', whyTitle: 'Photo highlights', whyText: '', plan: 'Neem contact op', eventsTitle: 'This week at CLINIQ', eventsText: '', noEventsTitle: 'Nieuwe events volgen.', noEventsText: '', albumsTitle: 'Photo highlights', albumsText: '', readyTitle: 'CLINIQ Maastricht', readyText: 'Platielstraat 9A. Midden in Maastricht.' },
  ...
  en: {
    ...
    home: { eyebrow: 'Club · Cocktails · Events', hero: 'CLINIQ Maastricht', intro: 'Club. Cocktails. Events.', proof: ['Platielstraat 9A', 'Club', 'Cocktails', 'Events'], whyEyebrow: 'Photos', whyTitle: 'Photo highlights', whyText: '', plan: 'Contact us', eventsTitle: 'This week at CLINIQ', eventsText: '', noEventsTitle: 'New events soon.', noEventsText: '', albumsTitle: 'Photo highlights', albumsText: '', readyTitle: 'CLINIQ Maastricht', readyText: 'Platielstraat 9A. In the centre of Maastricht.' },
