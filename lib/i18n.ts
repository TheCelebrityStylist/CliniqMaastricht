...
export const ui = {
  nl: {
    ...
    footer: { headline: 'CLINIQ Maastricht', text: 'Platielstraat 9A, Maastricht.', intro: 'Platielstraat 9A, Maastricht.', navigation: 'Navigatie', groups: 'Voor groepen', bachelor: 'Vrijgezellenfeest', corporate: 'Bedrijfsfeest', venue: 'Feestzaal Maastricht', route: 'Route & contact', lockers: 'Lockers' },
  ...
  en: {
    ...
    home: { eyebrow: 'Platielstraat 9A', hero: 'CLINIQ Maastricht', intro: 'Nights, events and workshops on Platielstraat.', proof: ['Platielstraat 9A', 'Club', 'Workshops', 'Events'], whyEyebrow: 'Photos', whyTitle: 'Photos', whyText: '', plan: 'Contact us', eventsTitle: 'Agenda', eventsText: 'The next nights at CLINIQ.', noEventsTitle: 'New events soon.', noEventsText: '', albumsTitle: 'Photos', albumsText: 'Recent nights at CLINIQ.', readyTitle: 'CLINIQ Maastricht', readyText: 'Platielstraat 9A, Maastricht.' },
    ...
    footer: { headline: 'CLINIQ Maastricht', text: 'Platielstraat 9A, Maastricht.', intro: 'Platielstraat 9A, Maastricht.', navigation: 'Navigation', groups: 'For groups', bachelor: 'Bachelor / bachelorette', corporate: 'Company event', venue: 'Venue hire Maastricht', route: 'Directions & contact', lockers: 'Lockers' },
