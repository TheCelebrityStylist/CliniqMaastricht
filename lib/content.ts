...
export const INTERACTIVE_COPY = {
  nl: {
    status: { openNow: 'Nu open', closesAt: 'tot', doorsOpenIn: 'Deuren open over', nextEvent: 'Volgende avond', tonight: 'Vanavond bij Cliniq', closed: 'Gesloten — tot snel', viewAgenda: 'Bekijk agenda' },
  ...
  en: {
    status: { openNow: 'Open now', closesAt: 'till', doorsOpenIn: 'Doors open in', nextEvent: 'Next night', tonight: 'Tonight at Cliniq', closed: 'Closed — see you soon', viewAgenda: 'View agenda' },
