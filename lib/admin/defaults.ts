...
// days - each with its own promo copy AND its own dedicated detail page (all 5 are `featured`;
// per the brief, only featured events get a detail page, and this is the set of 5). Doors/close
// default to 22:00-03:00 (matching every other night) since Sanity has no exact per-event times
// in this environment - flagged for owner confirmation in the report, same as the spelling of
// "Amphitryon", what "Koko"/"Stennis"/"John Tana" are, and whether "Preuve" = Preuvenemint and
// CLINIQ can truthfully call itself its "official" afterparty. The Aug 26 weekday text is
// corrected to Woensdag (26 Aug 2026 is a Wednesday, not the brief's "Di"/Tuesday) while keeping
// the explicit date. Age limits: 18+ kept for the three Inkom nights + ESN (student-audience
// events, matching the venue's existing Thu 18+ pattern); 21+ used for the Sun 30 Aug Preuve
// afterparty since it isn't an Inkom-specific night (matches the existing Fri/Sat 21+ default) -
// this is a judgment call flagged in the report per the brief's own "others 21+?" question.
const inkomWeekEvents: AgendaEvent[] = [
  {
    _id: 'agenda-2026-08-17-amphitryon-inkom-party',
    title: 'Inkom Opening — Amphitryon × CLINIQ',
    titleNl: 'Inkom Opening — Amphitryon × CLINIQ',
    titleEn: 'Inkom Opening — Amphitryon × CLINIQ',
    subtitleNl: 'Inkom Opening met Amphitryon',
    subtitleEn: 'Inkom Opening with Amphitryon',
    categoryTagNl: 'INKOM',
    categoryTagEn: 'INKOM',
    ...
    ageLimit: '18+',
    fullDescriptionNl:
      "De Inkom begint hier. Maandag 17 augustus opent CLINIQ het studentenjaar samen met Amphitryon — de eerste grote nacht van je Inkom, midden op de Platielstraat. Nieuwe stad, nieuwe mensen, één dansvloer. Dit is waar Maastricht je welkom heet. Deuren 22:00, open tot 03:00. Kom op tijd, want vol is vol.",
    fullDescriptionEn:
      "This is where Inkom begins. On Monday 17 August, CLINIQ opens the student year together with Amphitryon — the first big night of your Inkom, right on Platielstraat. New city, new people, one dancefloor. This is how Maastricht says welcome. Doors 22:00, open until 03:00. Arrive early — once it's full, it's full.",
    metaTitleNl: 'Inkom Opening — Amphitryon × CLINIQ · Ma 17 aug Maastricht',
    metaTitleEn: 'Inkom Opening — Amphitryon × CLINIQ · Mon 17 Aug Maastricht',
    metaDescriptionNl: 'Start je Inkom bij CLINIQ. Amphitryon-openingsfeest op de Platielstraat, maandag 17 augustus — dé eerste nacht van het studentenjaar in Maastricht.',
    metaDescriptionEn: 'Start your Inkom at CLINIQ. Amphitryon opening night on Platielstraat, Monday 17 August — the first night of the student year in Maastricht.',
    featured: true,
    eventType: 'featured',
    showDetailCTA: true,
    published: true,
    imageUrl: images.party,
    imageAlt: 'Inkom Opening — Amphitryon × CLINIQ, Maastricht',
  ...
  },
  {
    ...
    ageLimit: '18+',
    fullDescriptionNl:
      'Van kroeg naar kroeg — en dan hierheen. Dinsdag 18 augustus strandt de Inkom Pubcrawl bij CLINIQ, samen met Koko. Je hebt de stad gezien; nu begint het echte werk op de dansvloer. De perfecte landing na de crawl. Deuren 22:00, open tot 03:00.',
    fullDescriptionEn:
      "From bar to bar — and then here. On Tuesday 18 August, the Inkom Pub Crawl lands at CLINIQ, together with Koko. You've seen the city; now the real work starts on the dancefloor. The perfect landing after the crawl. Doors 22:00, open until 03:00.",
  ...
  },
  {
    ...
    ageLimit: '18+',
    fullDescriptionNl:
      'Het hoogtepunt van je Inkom-week. Woensdag 19 augustus neemt Stennis de knoppen over voor de Stennis Inkom-party. Beats die niet stoppen, een dansvloer die vol staat en de nacht waar iedereen het na de Inkom nog over heeft. Deuren 22:00, open tot 03:00. Wees erbij.',
    fullDescriptionEn:
      "The highlight of your Inkom week. On Wednesday 19 August, Stennis takes over the decks for the Stennis Inkom Party. Beats that don't stop, a dancefloor that stays packed, and the night everyone's still talking about after Inkom. Doors 22:00, open until 03:00. Be there.",
  ...
  },
  {
    ...
    title: 'ESN Party — International Students Night',
    titleNl: 'ESN Party — International Students Night',
    titleEn: 'ESN Party — International Students Night',
    ...
    ageLimit: '18+',
    fullDescriptionNl:
      'Eén dansvloer, dertig nationaliteiten. Woensdag 26 augustus neemt ESN CLINIQ over voor de internationale studentennacht van Maastricht. Nieuwe gezichten, nieuwe vrienden, dezelfde muziek waar we het allemaal voor doen. Erasmus of local — vanavond danst iedereen samen. Deuren 22:00, open tot 03:00.',
    fullDescriptionEn:
      "One dancefloor, thirty nationalities. On Wednesday 26 August, ESN takes over CLINIQ for Maastricht's international students night. New faces, new friends, the same music that brings us all together. Erasmus or local — tonight, everyone dances as one. Doors 22:00, open until 03:00.",
    metaTitleNl: 'ESN Party · International Students Night · Wo 26 aug CLINIQ Maastricht',
    metaTitleEn: 'ESN Party · International Students Night · Wed 26 Aug CLINIQ Maastricht',
    metaDescriptionNl: 'ESN neemt CLINIQ over voor de internationale studentennacht, woensdag 26 augustus. Erasmus students & locals, één dansvloer, midden in Maastricht.',
    metaDescriptionEn: 'ESN takes over CLINIQ for the international students night, Wednesday 26 August. Erasmus students & locals, one dancefloor, in the heart of Maastricht.',
    featured: true,
    eventType: 'featured',
    showDetailCTA: true,
    published: true,
    imageUrl: images.hero,
    imageAlt: 'ESN Party — International Students Night bij CLINIQ Maastricht',
    imagePosition: 'center',
  },
  {
    ...
    subtitleNl: 'De afterparty van Preuve',
    subtitleEn: 'The Preuve afterparty',
    ...
    ageLimit: '21+',
    fullDescriptionNl:
      'Als het Vrijthof leegloopt, begint het hier pas. Zondag 30 augustus is CLINIQ de afterparty van Preuve, met John Tana. Van het terras naar de dansvloer — de laatste warme nacht van de zomer, midden in Maastricht. Deuren 22:00, open tot 03:00.',
    fullDescriptionEn:
      'When Vrijthof empties out, this is where it really starts. On Sunday 30 August, CLINIQ hosts the afterparty of Preuve, with John Tana. From the terrace to the dancefloor — the last warm night of summer, right in the heart of Maastricht. Doors 22:00, open until 03:00.',
    ...
    metaDescriptionNl: 'De officiële afterparty van Preuve bij CLINIQ met John Tana, zondag 30 augustus. De laatste zomernacht op de Platielstraat in Maastricht.',
    metaDescriptionEn: 'The official afterparty of Preuve at CLINIQ with John Tana, Sunday 30 August. The last summer night on Platielstraat in Maastricht.',
    featured: true,
    eventType: 'featured',
    showDetailCTA: true,
    published: true,
