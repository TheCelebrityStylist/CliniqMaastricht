...
export const defaultStore: AdminStore = {
  ...
  pages: [
    ...
    { key: 'jobs', titleNl: 'Vacatures', titleEn: 'Jobs', heroTitleNl: 'Werken bij CLINIQ', heroTitleEn: 'Work at CLINIQ', heroSubtitleNl: 'Bij Cliniq werk je op de avonden dat anderen op stap gaan. Goed team, goede energie. Zoek jij iets bij?', heroSubtitleEn: 'At Cliniq you work the nights others go out. Good team, good atmosphere. Looking for something?' },
  ...
  seo: [],
  leads: [],
  jobs: [{ _id: 'open', title: 'Open sollicitatie', type: 'Parttime', description: 'Je staat drie avonden per week achter de bar van een van de drukste clubs van Maastricht. Goed in multitasken, kalm onder druk en altijd vriendelijk. Ervaring is een pré maar niet vereist.', requirements: ['Gastvrij', 'Beschikbaar in avonden/weekenden', 'Teamspeler'], published: true }],
