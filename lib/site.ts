export const site = {
  ...
  description: 'Uitgaan in Maastricht? CLINIQ is dé club aan de Platielstraat. Clubavonden, cocktail workshops en ruimte voor besloten feesten. Open do, vr & za.',
...
export const images = {
  ...
  party: 'https://images.squarespace-cdn.com/content/v1/668daa9a16b2fb43c8ce6f80/4fa88dae-1327-499e-95c4-6f2e95bf02b3/4_Wildschieters_JtT_Cliniq_20230318.JPG',
  ...
  whiskey: 'https://images.squarespace-cdn.com/content/v1/668daa9a16b2fb43c8ce6f80/be637eab-7863-4dbd-af9b-e33732d136b0/DSCF4832.jpg',
  mixing: 'https://images.squarespace-cdn.com/content/v1/668daa9a16b2fb43c8ce6f80/98da1243-060f-441e-9571-025f85aa299c/DSCF4870.jpg',
...
export const imageSets = {
  home: [images.hero, images.redCrowd, images.bar, images.workshopBar, images.party, images.club],
  nightlife: [images.hero, images.redCrowd, images.club, images.party, images.redRoom],
  workshop: [images.mojito, images.whiskey, images.espresso, images.passion, images.mixing],
  eventSpace: [images.redRoom, images.club, images.party, images.crowd, images.contactInterior],
