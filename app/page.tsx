...
export default async function Home() {
  ...
  return <>
    <section className="relative min-h-screen overflow-hidden pt-28">
      ...
      <div className="container-premium flex min-h-[calc(100vh-7rem)] items-end pb-20">
        <div className="reveal max-w-5xl">
          ...
          <p className="mt-5 text-2xl font-black tracking-[-0.03em] text-white/82 sm:text-4xl">Cocktails. Muziek. Mensen.</p>
    ...
    <section className="container-premium py-20">
      <div className="mb-8 flex items-end justify-between gap-4"><div><h2 className="h2">Deze week</h2><p className="mt-3 text-white/60">De eerstvolgende avonden bij CLINIQ.</p></div><Link href="/uitgaan" className="btn-secondary hidden sm:inline-flex">{t.common.allEvents}</Link></div>
    ...
    <section className="container-premium pb-20">
      <div className="mb-8 flex items-end justify-between gap-4"><div><h2 className="h2">Foto’s</h2><p className="mt-3 text-white/60">Een kleine selectie uit de laatste avonden.</p></div><Link href="/fotos" className="btn-secondary hidden sm:inline-flex">{t.common.allPhotos}</Link></div>
    ...
    <section className="container-premium grid gap-5 pb-20 lg:grid-cols-2">
      <Promo href="/cocktail-workshop" image={images.workshopBar} title="Cocktail workshop." text="Voor groepen die iets anders zoeken dan een standaard borrel." cta="Meer informatie" />
    ...
    <section className="container-premium pb-20"><div className="border-y border-white/10 py-8"><h2 className="eyebrow">Praktisch</h2><div className="mt-6 grid gap-6 text-white/70 md:grid-cols-3"><p>Donderdag, vrijdag en zaterdag.</p><p>Neem altijd je ID mee.</p><p>Lockers via de lockerlink.</p></div></div></section>
