...
export default async function Home() {
  ...
  return <>
    <section className="relative min-h-[92vh] overflow-hidden pt-32">
      ...
      <div className="absolute inset-0 -z-10 bg-gradient-to-r from-black via-black/65 to-burgundy/25" />
      <div className="container-premium py-20">
        ...
        <p className="mt-7 max-w-2xl text-xl leading-8 text-white/78">Cliniq Maastricht is de stijlvolle club, cocktailbar en eventlocatie in het hart van de stad — gebouwd voor avonden die blijven hangen.</p>
    ...
    <section className="border-y border-white/10 bg-white/[0.04] py-5"><div className="container-premium grid gap-4 text-sm font-black uppercase tracking-[0.18em] text-white/72 md:grid-cols-4"><span>Platielstraat 9A</span><span>Club Maastricht</span><span>Cocktail workshops</span><span>Private events</span></div></section>
