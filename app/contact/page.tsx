...
export default async function ContactPage(){
  ...
  return <>
    ...
    <JsonLd data={breadcrumbSchema([{ name: 'Home', url: site.url }, { name: 'Contact', url: `${site.url}/contact` }])} />
  </>
}
