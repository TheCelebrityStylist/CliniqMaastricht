...
export default async function NightlifePage() {
  ...
  return <>
    <section className="relative min-h-[78vh] overflow-hidden pt-36"><SafeImage src={images.redCrowd} fallbackSrc={images.fallbackHero} alt="CLINIQ Maastricht club night with red and blue light" fill priority sizes="100vw" className="-z-10 object-cover brightness-[1.08]" /><div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(0,0,0,.86),rgba(0,0,0,.42),rgba(0,0,0,.7)),linear-gradient(0deg,rgba(8,6,7,.94),transparent_45%)]" /><div className="container-premium py-24"><p className="eyebrow">Agenda</p><h1 className="h1 mt-5 max-w-5xl">Nightlife at CLINIQ</h1><p className="mt-7 max-w-2xl text-xl leading-8 text-white/76">Every Thursday, Friday and Saturday, CLINIQ turns into a club night with cocktails, DJs and a grown-up atmosphere in the centre of Maastricht. Check the agenda, arrive on time and bring your ID.</p></div></section>
