...
export default async function ContactPage(){
  ...
  return <>
    ...
    <JsonLd data={breadcrumbSchema([{ name: 'Home', url: `${site.url}/en` }, { name: 'Contact', url: `${site.url}/en/contact` }])} />
  </>
}
