...
export default async function HomeEn() {
  ...
  // Featured events (portrait promo flyers) are excluded from this preview grid - it uses the
  // same landscape EventCard as the full agenda, which no longer renders flyer artwork at all
  // (see FeaturedEventsSection.tsx).
    ...
    <>
      ...
      <section className="event-section section-y">
        <div className="container-premium">
          ...
          {events.length > 3 ? (
            <Link href="/en/nightlife" className="focus-ring mt-4 inline-flex min-h-11 items-center text-sm font-black uppercase tracking-[0.1em] text-coral-text hover:text-white md:hidden">
              {t.common.allEvents} →
            </Link>
          ) : null}
        </div>
