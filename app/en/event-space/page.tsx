...
export default function EventSpacePage(){
  ...
  return <>
    ...
    <section className="container-premium section-y"><p className="eyebrow">Event types</p><h2 className="h2 mt-4">What can you hire CLINIQ for?</h2><div className="mt-8"><EventTypeCards cards={eventTypes.map(([title, text], index) => ({ title, image: EVENT_TYPE_PHOTOS[index % EVENT_TYPE_PHOTOS.length], href: '#inquiry', description: text }))} /></div></section>
