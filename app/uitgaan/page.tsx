...
export default async function NightlifePage() {
  ...
  return <>
    <section className="hero-section relative min-h-[82vh] overflow-hidden pt-36">
      ...
      <div className="container-premium py-24"><p className="eyebrow mb-4">Agenda</p><h1 className="h1 max-w-5xl">Uitgaan bij CLINIQ</h1><p className="mt-7 max-w-3xl text-xl leading-8 text-white/78">Op donderdag, vrijdag en zaterdag is CLINIQ open voor clubavonden en groepen. Midden in Maastricht, met muziek, drankjes en een duidelijke agenda per avond.</p></div>
    </section>
