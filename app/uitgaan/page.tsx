...
export default async function UitgaanPage() {
  ...
  return <>
    <section className="relative min-h-[78vh] overflow-hidden pt-36">
      ...
      <div className="container-premium py-24"><p className="eyebrow">Agenda</p><h1 className="h1 mt-5 max-w-5xl">{content?.heroTitle || 'Uitgaan bij CLINIQ'}</h1><p className="mt-7 max-w-2xl text-xl leading-8 text-white/76">{content?.heroSubtitle || 'Elke donderdag, vrijdag en zaterdag verandert CLINIQ in een clubavond met cocktails, DJ’s en een volwassen sfeer midden in Maastricht. Check de agenda, kom op tijd en neem je ID mee.'}</p></div>
    </section>
