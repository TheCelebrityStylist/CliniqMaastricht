...
export default async function WorkshopPage(){
  ...
  return <>
    ...
    <section className="container-premium pb-24"><div className="seo-panel grid gap-8 rounded-[2rem] border border-white/10 bg-white/[0.045] p-7 md:p-10 lg:grid-cols-[.8fr_1.2fr]"><div><p className="eyebrow">Maastricht</p><h2 className="h2 mt-4">Cocktail workshop in Maastricht</h2></div><p className="text-lg leading-[1.65] text-white/72 md:text-xl">Een cocktail workshop in Maastricht is ideaal als je met een groep iets zoekt dat actief, sociaal en makkelijk te combineren is met een avond uit. Bij CLINIQ vindt de workshop plaats in een echte cocktailbar in het centrum van Maastricht. Daardoor voelt de setting direct anders dan een standaard workshopruimte. Je leert cocktails maken, krijgt begeleiding van bartenders en kunt de workshop combineren met borrelen, uitgaan of een private event.</p></div></section>
